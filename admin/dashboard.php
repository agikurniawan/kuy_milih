...
<html>
  ...
  <body class="hold-transition skin-green sidebar-mini" >
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'user') { echo 'class="active"'; } ?>>
                <a href="?page=user"><i class="fa fa-users"></i>  <span>Manajemen Pemilih</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'rw') { echo 'class="active"'; } ?>>
                <a href="?page=rw"><i class="fa fa-users"></i> <span>Manajemen Calon Rw</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'rt') { echo 'class="active"'; } ?>>
                <a href="?page=rt"><i class="fa fa-users"></i> <span>Manajemen Calon Rt</span></a>
            </li>
            <li class="header">Data</li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'data_rt') { echo 'class="active"'; } ?>>
                <a href="?page=data_rt"><i class="fa fa-university"></i> <span>Data Rt</span></a>
            </li>
                  ...
                  if(isset($_GET['page'])) {
                      switch ($_GET['page']) {
                        case 'user':
                            ...
                            break;
                        case 'data_rt':
                            include('./data_rt/index.php');
                            break;
                        case 'rw':
                            include('./rw/index.php');
                            break;
                        case 'rt':
                            include('./rt/index.php');
                            break;
                        case 'user':
                            include('./user/index.php');
                            break;
    ...
    <?php
    if (isset($_GET['page']) && $_GET['page'] == 'rw') { ?>
      function tampil() {
          $.ajax({
            url: 'ajax_rw.php',
            method: "GET",
    ...
    <?php
    if (isset($_GET['page']) && $_GET['page'] == 'rt') { ?>
      function tampil() {
          $.ajax({
            url: 'ajax_rt.php',
            method: "GET",
