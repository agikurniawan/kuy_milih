...
?>
<h3>Tambah Calon Rw</h3>
<hr />
<div class="row">
    <div class="col-md-8">
        <form action="./rw/simpan.php" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group" style="padding-top:20px;">
                <div class="col-md-offset-3 col-md-8">
                    <button type="submit" name="add_rw" value="Tambah Calon" class="btn btn-success">
                        Tambah Calon
                    </button>
