...
if(isset($_POST['add_user'])) {
   ...
   $kls  = $_POST['kelas'];
   //cek nis
   $get_id = $con->prepare("SELECT * FROM t_pemilih WHERE id_pemilih = ?");
   ...
   if($nis == '' || $nama == '' || $jk == '' || $kls == '') {
      ...
      $sql = $con->prepare("INSERT INTO t_pemilih(id_pemilih, fullname, id_kelas, jk) VALUES(?, ?, ?, ?)");
    ...
    <div class="col-md-8 col-sm-12">
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" type="number" name="nik" placeholder="NIK" type="number"/>
                </div>
            </div>
