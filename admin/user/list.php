...
<div class="row">
   ...
   <div class="col-md-3 col-sm-3" style="padding-top:10px;">
      <a class="btn btn-primary" href="?page=user&action=tambah">Tambah</a>
   </div>
   ...
   <div class="col-md-10 col-sm-12">
      <table class="table table-striped table-hover">
            ...
            <tbody>
                  ...
                  $sql = mysqli_query($con, "SELECT * FROM t_pemilih JOIN t_kelas ON t_pemilih.id_kelas = t_kelas.id_kelas LIMIT $start,5");
                  ...
                  while($data = mysqli_fetch_array($sql)) {
                        ...
                        <td style="text-align:center;vertical-align:middle;">
                              <a href="?page=user&action=edit&id=<?php echo $data['id_pemilih']; ?>" class="btn btn-warning btn-sm">
                              Edit
                              </a>
                              <a href="?page=user&action=hapus&id=<?php echo $data['id_pemilih']; ?>" onclick="return confirm('Yakin ingin menghapus user ini ?');" class="btn btn-danger btn-sm">
                              Hapus
                              </a>
                        </td>
                        </tr>
      ...
      <?php
         ...
         $hitung = mysqli_num_rows(mysqli_query($con, "SELECT * FROM t_pemilih"));
